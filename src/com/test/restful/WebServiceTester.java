...
public class WebServiceTester  {
   ...
   private String REST_SERVICE_URL = "http://localhost:8080/RESTJersey/rest/UserService/users";
...
//      tester.testDeleteUser();
   ...
   private void testUpdateUser(){
      Form form = new Form();
      form.param("id", "1");
      form.param("name", "Rahamathullah S");
      form.param("profession", "Technical Project Manager");
